...
printf("TG_mul: success %ld ms.\n", time_b - time_a);
printfflush();

time_a = call LocalTime.get();
call ECC.add(&P2, &(param->G), &(param->G));
time_b = call LocalTime.get();
printf("TG_add: success %ld ms.\n", time_b - time_a);
printfflush();
