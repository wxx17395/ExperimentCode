...
public class show_ecdsa implements MessageListener
{
	...
	if(msg instanceof private_key_msg){
		...
		System.out.print("Average timing result" + "\n");
		System.out.print("ECC.init(): " + ecc_init_total/round + "\n");
		System.out.print("ECDSA.init(): " + ecdsa_init_total/round + "\n");
		System.out.print("public key gen: " + pubkey_total/round + "\n");
		System.out.print("sign: " + sign_total/round + "\n");
		System.out.print("verify: " + verify_total/round + "\n");
